...
impl ServiceBuilder {
    ...
    fn construct_characteristic_static(&mut self, characteristic: Characteristic) {
        ...
        self.code_build_chars.extend(quote_spanned! {characteristic.span=>
            let #char_name = {
                static #name_screaming: static_cell::StaticCell<[u8; <#ty as trouble_host::types::gatt_traits::GattSized>::MAX_SIZE]> = static_cell::StaticCell::new();
                ...
                let store = #name_screaming.init([0; <#ty as trouble_host::types::gatt_traits::GattSized>::MAX_SIZE]);
