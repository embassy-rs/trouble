...
pub mod prelude {
    ...
    pub use super::{BleHostError, Controller, Error, Host, HostConfig, HostResources, Stack};
...
impl<const CONNS: usize, const CHANNELS: usize, const ADV_SETS: usize> Default
    for HostResources<CONNS, CHANNELS, ADV_SETS>
{
    fn default() -> Self {
        Self::new()
    }
...
impl<const CONNS: usize, const CHANNELS: usize, const ADV_SETS: usize> HostResources<CONNS, CHANNELS, ADV_SETS> {
...
pub fn new<'resources, C: HostConfig, const CONNS: usize, const CHANNELS: usize, const ADV_SETS: usize>(
    controller: C::Controller,
    resources: &'resources mut HostResources<CONNS, CHANNELS, ADV_SETS>,
) -> Stack<'resources, C> {
    ...
    let host: BleHost<'_, C> = BleHost::new(controller, connections, channels, advertise_handles);
